...
## Trigger rules
- If the user explicitly names a skill (for example `$go`, `go`, `$hl7dicom`, `hl7dicom`), use that skill in the current turn.
...
- If both skills are relevant, use the minimum combination and state the order.
